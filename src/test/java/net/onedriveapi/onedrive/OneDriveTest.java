package net.onedriveapi.onedrive;

import net.onedriveapi.onedrive.core.OneDrive;
import net.onedriveapi.onedrive.core.Principal;
import net.onedriveapi.onedrive.enums.FriendlyNamesEnum;
import net.onedriveapi.onedrive.json.User;
import net.onedriveapi.onedrive.json.folder.Data;
...
public class OneDriveTest {
   ...
   // @Test
    ...
    public void uploadDownloadRenameAndDeleteFileTest() throws Exception {
        ...
        net.onedriveapi.onedrive.json.folder.File oneDriveFile = oneDriveAPI.uploadFile(oneDriveTestfile, "");
        assertNotNull(oneDriveFile);

        oneDriveFile.setName("renamedfile1.docx");
        oneDriveFile.setDescription("Renamed description");

        oneDriveAPI.updateFile(oneDriveFile);

        net.onedriveapi.onedrive.json.folder.File oneDriveFileRenamed = oneDriveAPI.getFile(oneDriveFile.getId());
        assertEquals(oneDriveFileRenamed.getName(),"renamedfile1.docx");
   ...
   // @Test
    public void createFolderTest() throws Exception {
        net.onedriveapi.onedrive.json.folder.Folder oneDriveFolder = oneDriveAPI.createFolder("Testfolder","Step1InitToken description","");
