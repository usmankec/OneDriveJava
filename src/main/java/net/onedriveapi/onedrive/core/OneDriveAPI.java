...
public interface OneDriveAPI {
     ...
     */
    void downloadFile(net.onedriveapi.onedrive.json.folder.File oneDriveFile, String destinationFilePath);
     ...
     * @throws Exception
     */
    net.onedriveapi.onedrive.json.folder.File getFile(String fileId) throws Exception;
     ...
     */
    void deleteFile(net.onedriveapi.onedrive.json.folder.File oneDriveFile) throws RestException;
     ...
     * @throws RestException
     */
    net.onedriveapi.onedrive.json.folder.Folder createFolder(String name, String description, String locationFolderId) throws RestException, IOException;
     ...
     * @throws Exception
     */
    net.onedriveapi.onedrive.json.folder.File uploadFile(java.io.File file, String folderId) throws Exception;
