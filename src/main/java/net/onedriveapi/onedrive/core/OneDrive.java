package net.onedriveapi.onedrive.core;
...
import net.onedriveapi.onedrive.enums.FriendlyNamesEnum;
import net.onedriveapi.onedrive.enums.OneDriveEnum;
import net.onedriveapi.onedrive.exception.RestException;
import net.onedriveapi.onedrive.json.Quota;
import net.onedriveapi.onedrive.json.SharedLink;
import net.onedriveapi.onedrive.json.User;
import net.onedriveapi.onedrive.json.folder.Folder;
...
public class OneDrive implements OneDriveAPI {
 ...
 //   @Override
   ...
   // @Override
     ...
     */
   // @Override
    public void downloadFile(net.onedriveapi.onedrive.json.folder.File oneDriveFile, String destinationFilePath) {
     ...
     */
   // @Override
    public net.onedriveapi.onedrive.json.folder.File getFile(String fileId) throws Exception {
        return (net.onedriveapi.onedrive.json.folder.File) oneDriveCore.doGetAPI(new MultivaluedMapImpl(), MediaType.APPLICATION_JSON, fileId, new net.onedriveapi.onedrive.json.folder.File());
    }
     ...
     */
  //  @Override
    public net.onedriveapi.onedrive.json.folder.Folder getFolder(String folderId) throws Exception {
        return (net.onedriveapi.onedrive.json.folder.Folder) oneDriveCore.doGetAPI(new MultivaluedMapImpl(), MediaType.APPLICATION_JSON, folderId, new net.onedriveapi.onedrive.json.folder.Folder());
    }
     ...
     */
   // @Override
    public void deleteFile(net.onedriveapi.onedrive.json.folder.File oneDriveFile) throws RestException {
     ...
     */
   // @Override
    public net.onedriveapi.onedrive.json.folder.File updateFile(net.onedriveapi.onedrive.json.folder.File oneDriveFile) throws RestException, IOException {
        return (net.onedriveapi.onedrive.json.folder.File) oneDriveCore.doPutAPI(new MultivaluedMapImpl(), MediaType.APPLICATION_JSON, oneDriveFile.getId(), oneDriveFile);
    }
     ...
     */
  //  @Override
    public net.onedriveapi.onedrive.json.folder.Folder updateFolder(net.onedriveapi.onedrive.json.folder.Folder oneDriveFolder) throws RestException, IOException {
     ...
     */
   // @Override
    public net.onedriveapi.onedrive.json.folder.Folder createFolder(String name, String description, String locationFolderId) throws RestException, IOException {
        String apiPath;
        net.onedriveapi.onedrive.json.folder.Folder oneDriveFolder = new Folder();
  ...
  //  @Override
     ...
     */
    public net.onedriveapi.onedrive.json.folder.File uploadFile(File file, String folderId) {
        net.onedriveapi.onedrive.json.folder.File oneDriveFile = new net.onedriveapi.onedrive.json.folder.File();
        ...
        try {
            ...
            oneDriveFile = objectMapper.readValue(clientResponse.getEntity(String.class).toString(), net.onedriveapi.onedrive.json.folder.File.class);
        } catch (Exception e) {
